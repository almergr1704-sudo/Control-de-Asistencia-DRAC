...
export const VIEW_TO_HASH: Record<string, string> = {
  ...
  org_bulk: '#/organizacion/carga-masiva',
  ...
  personnel_encargaturas: '#/directorio-personal/encargaturas',
  personnel_bulk: '#/directorio-personal/carga-masiva',
...
export const VIEW_TO_GROUP: Record<string, string> = {
  ...
  personnel_encargaturas: 'personnel',
  personnel_bulk: 'personnel',
